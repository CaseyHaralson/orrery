# Codex Agent - Orchestrated Workflow Protocol

This configuration enables Codex to operate in two modes based on the Agent Workflow Protocol defined in `agent/policies/WORKFLOW.md`.

## Mode Detection

Codex automatically detects which mode to operate in based on the input context:
