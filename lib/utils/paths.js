...
function getWorkDir() {
  ...
  if (envDir && envDir.trim()) {
    ...
    workDir = ensureDir(projectScoped);
  } else {
    workDir = ensureDir(path.join(getEffectiveRoot(), ".agent-work"));
  }
  ensureWorkDirGitignore(workDir);
  return workDir;
}

function ensureWorkDirGitignore(workDir) {
