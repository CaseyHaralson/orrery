...
- Plans with blocked steps were incorrectly archived as complete, preventing resume
...
- Failover now triggers on any agent error, not just specific error patterns
...
- Plan detail view shows `completed_at` timestamp and per-plan log file path when available
...
[Unreleased]: https://github.com/CaseyHaralson/orrery/compare/v0.13.1...HEAD
[0.13.1]: https://github.com/CaseyHaralson/orrery/compare/v0.13.0...v0.13.1
