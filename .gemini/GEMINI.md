# Gemini Agent - Orchestrated Workflow Protocol

This configuration enables Gemini to operate in two modes based on the Agent Workflow Protocol defined in `agent/policies/WORKFLOW.md`.
